    ...
    return (
        <div className="relative min-h-screen bg-slate-50 dark:bg-[#020617] text-slate-900 dark:text-white font-sans selection:bg-cyan-500/30 overflow-hidden pt-20 transition-colors duration-500">
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 py-16">
                ...
                {(plans.length > 0 ? plans : DEFAULT_PLANS).length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch max-w-7xl mx-auto mb-32">
                        {PLAN_DETAILS.map((plan, idx) => (
                            <div 
                                key={idx} 
                                className={`relative flex flex-col bg-white dark:bg-slate-900/40 backdrop-blur-md border rounded-[2.5rem] p-8 transition-all duration-300 group hover:-translate-y-2 shadow-xl dark:shadow-none overflow-hidden ${
                                    plan.featured 
                ...
                <div className="mb-8">
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-4 transition-transform group-hover:scale-110 ${plan.featured ? 'bg-cyan-100 dark:bg-cyan-900/30' : 'bg-slate-100 dark:bg-slate-800'
                        }`}>
                        {plan.icon}
                    </div>
                ...
                {paymentStep === 'details' && (
                    <div className="p-6">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <button
                                            ...
                                            className={`p-4 rounded-2xl border text-center flex flex-col items-center justify-center gap-2 transition-all hover:scale-102 ${paymentGateway === 'bkash'
                                        ...
                                        <button
                                            ...
                                            className={`p-4 rounded-2xl border text-center flex flex-col items-center justify-center gap-2 transition-all hover:scale-102 ${paymentGateway === 'ssl'
                        ...
                        <button
                            ...
                            className={`w-full py-3.5 font-bold rounded-xl shadow-lg flex items-center justify-center gap-2 transition-all transform hover:-translate-y-1 active:scale-[0.98] ${selectedPlan === 'Starter' || isDiscountApplied
